...
class TextCreation(Scene):
    def construct(self):
        text = TextMobject("\\text{Archimedes method of finding}",r"$\pi$")
        ...
        text.set_color_by_tex("\\text{Archimedes method of finding}",YELLOW)
        ...
        text7 = TextMobject("\\text{each polygon and joining the the two collinear vertices.}")
